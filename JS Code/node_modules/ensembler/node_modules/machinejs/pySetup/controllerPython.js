...
var startOneClassifier = function(classifierList) {
  ...
  if( classifierList.length > 0 ) {
    ...
    // TODO TODO: figure out why we're not skipping training of algos
    // TODO TODO: figure out why we're not freeing up the cpu space to be used again when we do skip (right now it's just sitting idle and only training one algo at a time)
    // TODO TODO: implement another threshold after the first round to eliminate any algos that are going to be hopeless
    // console.log('global.trainedAlgoCounts[classifierName]',global.trainedAlgoCounts[classifierName]);
    // console.log('algosBestScore',algosBestScore);
    // console.log('global.bestSearchScore * argv.continueToTrainThreshold',global.bestSearchScore * argv.continueToTrainThreshold);
